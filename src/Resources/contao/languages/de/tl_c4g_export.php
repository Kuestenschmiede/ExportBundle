...
$GLOBALS['TL_LANG'][$strName]['sender']         = ['Absender', 'Die E-Mail-Adresse des Absenders.'];
...
$GLOBALS['TL_LANG'][$strName]['loadChildTableData'] = ['Daten aus Kindtabellen laden', ''];
$GLOBALS['TL_LANG'][$strName]['childTables'] = ['Zu ladende Kinddaten', ''];
...
$GLOBALS['TL_LANG'][$strName]['exportConfirm'] = 'Wollen Sie den Export jetzt durchführen?';